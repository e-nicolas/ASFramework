package com.freshplanet.lib.ui.scroll.mobile
{
	...
	public class ScrollController extends EventDispatcher
	{
		...
		private static const SCROLLING_MAX_SPEED : Number = 20; // in pixels/ms //defauel 3
		...
		private static const FORCED_ANIMATED_SCROLLING_MAX_SPEED : Number = 20; // in pixels/ms //default 8
		
		// Scroll bars appearance
		private static const SCROLLBAR_THICKNESS : Number = 8;
		...
		//	SCROLLING_MIN_AMPLITUDE : Number = 1 * ConfigVars.ConfigVars.DPI_SCALE; // in pixels
		//	SCROLLING_MIN_SPEED : Number = 0.01 * ConfigVars.DPI_SCALE; // in pixels/ms
		//	SCROLLING_MAX_SPEED : Number = 4; // in pixels/ms
		//	FREE_SCROLLING_FRICTION_COEF : Number = 0.0015 * ConfigVars.DPI_SCALE;
		//	BOUNCING_FRICTION_COEF : Number = 3 * ConfigVars.DPI_SCALE;
		//	BOUNCING_SPRING_RATE : Number = 0.03 * ConfigVars.DPI_SCALE;
		//	BOUNCING_FINGER_SLOW_DOWN_COEF : Number = 0.5 * ConfigVars.DPI_SCALE;
		//	FORCED_ANIMATED_SCROLLING_MIN_DURATION : Number = 150; // in ms
		//	FORCED_ANIMATED_SCROLLING_MAX_SPEED : Number = 8; // in pixels/ms
		//
		//	// Scroll bars appearance
		//	SCROLLBAR_THICKNESS : Number = 8 * ConfigVars.DPI_SCALE;
		//	SCROLLBAR_MIN_LENGTH_WHEN_FREE : Number = 100 * ConfigVars.DPI_SCALE;
		//	SCROLLBAR_MIN_LENGTH_WHEN_BOUNCING : Number = 10 * ConfigVars.DPI_SCALE;
		//	SCROLLBAR_CORNER_RADIUS : Number = 10 * ConfigVars.DPI_SCALE;
		//	SCROLLBAR_SIDE_MARGIN : Number = 2 * ConfigVars.DPI_SCALE;
		//	
			super();
		}
		...
		private function onMouseDown( event : MouseEvent ) : void
		{
			...
			_container.addEventListener(MouseEvent.RELEASE_OUTSIDE, onMouseUp, false, 0, true);
			_container.addEventListener(Event.ENTER_FRAME, onEnterFrame, false, 0, true);
